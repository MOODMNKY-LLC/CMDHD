...
// Based on "The Story We're Telling Ourselves" outline
...
export const presentationSlides: Slide[] = [
  ...
  },
  {
    ...
    placeholder: `Share one specific action you'll take...`,
    talkingPoints: [
  ...
  },
  {
    ...
    sectionIndex: 10,
    duration: 0.5,
    quote: `Boundaries don't limit compassion—they define it.`,
